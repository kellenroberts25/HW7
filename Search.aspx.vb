...
Partial Class Search
    ...
    Protected Sub tb_search2_TextChanged(sender As Object, e As EventArgs) Handles tb_search2.TextChanged
        ...
        searchword = "Select * From karoberts_HW7 where (FirstName Like '%" + tb_search2.Text.ToString() + "%') OR (LastName Like '%" + tb_search2.Text.ToString() + "%') OR (Age Like '%" + tb_search2.Text.ToString() + "%') Or (Position Like '%" + tb_search2.Text.ToString() + "%') OR (Salary Like '%" + tb_search2.Text.ToString() + "%') OR (WinsAboveReplacement Like '%" + tb_search2.Text.ToString() + "%') OR (AllStar Like '%" + tb_search2.Text.ToString() + "%')"
